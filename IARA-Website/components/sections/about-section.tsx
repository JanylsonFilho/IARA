    ...
    <section id="sobre" className="py-20 sm:py-28 bg-[#FFE6CB]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center">
          ...
          <p className="mx-auto mt-4 text-xl text-[#414042]">Do Coração da Comunidade para o Futuro da Tecnologia</p>
        </AnimatedSection>

        <AnimatedSection delay={200} className="mx-auto mt-12 max-w-4xl">
          <div className="space-y-6 text-center text-lg text-[#414042]">
